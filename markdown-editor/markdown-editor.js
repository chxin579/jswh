...
(function (factory) {
     ...
     */
    $h = {
        CREDITS: '<a class="text-info" href="https://qwlog.com">编辑器</a>',
        CREDITS_MD: '[markdown编辑器](by qwlog.com)',
        BS4_VER: '4.4.1',
        BS3_VER: '3.3.7',
        DEFAULT_TIMEOUT: 250,
        EMPTY: '',
        NAMESPACE: '.markdownEditor',
        LINK_CM: '<a href="https://qwlog.com" target="_blank">qwlog</a>',
        LINK_MI: '<a href="https://qwlog.com" target="_blank">qwlog</a>',
    ...
    $defaults = {
        ...
        icons: {
            undo: '<span class="icon-ccw"></span>',
            redo: '<span class="icon-cw"></span>',
            bold: '<span class="icon-bold"></span>',
            italic: '<span class="icon-italic"></span>',
            ins: '<span class="icon-underline"></span>',
            del: '<span class="icon-strike"></span>',
            sup: '<span class="icon-superscript"></span>',
            sub: '<span class="icon-subscript"></span>',
            mark: '<span class="icon-pencil"></span>',
            paragraph: '<span class="icon-paragraph"></span>',
            newline: '<span class="icon-text-height"></span>',
            heading: '<span class="icon-header"></span>',
            link: '<span class="icon-link"></span>',
            image: '<span class="icon-picture"></span>',
            indent: '<span class="icon-indent-right"></span>',
            outdent: '<span class="icon-indent-left"></span>',
            ul: '<span class="icon-list-bullet"></span>',
            ol: '<span class=" icon-list-numbered"></span>',
            dl: '<span class="icon-th-list"></span>',
            footnote: '<span class="icon-sticky-note"></span>',
            blockquote: '<span class="icon-quote-left"></span>',
            code: '<span class="icon-code"></span>',
            codeblock: '<span class="icon-file-code"></span>',
            hr: '<span class="icon-minus"></span>',
            emoji: '<span class="icon-smile"></span>',
            fullscreen: '<span class=" icon-resize-full"></span>',
            minscreen: '<span class="icon-resize-small"></span>',
            hint: '<span class="icon-lightbulb"></span>',
            modePreview: '<span class="icon-search"></span>',
            modeEditor: '<span class="icon-edit"></span>',
            modeSplit: '<span class="icon-arrows-cw"></span>',
            export: '<span class="icon-download"></span>',
            exportHtml: '<span class="icon-doc-inv"></span>',
            exportText: '<span class="icon-doc-text-inv"></span>',
            alertMsg: '<span class="icon-exclamation"></span>',
            dialogCancel: '<span class="icon-calendar-times-o"></span>',
            dialogSubmit: '<span class="icon-ok"></span>'
        },
        buttonAccessKeys: {
            undo: 'z',
            redo: 'y',
            ...
            switch (key) {
                ...
                case 'heading':
                    $btn.html(label + ' ').attr({'data-toggle': 'dropdown'})
                        .addClass(btnCss + ' dropdown-toggle');
